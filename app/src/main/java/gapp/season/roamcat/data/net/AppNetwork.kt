...
object AppNetwork {
    ...
    const val API_APP_UPDATE_CONFIG = "http://poem.ehorizon.top/roamcat/apk-x/config.json"
    const val API_SOLAR_DATUM_DATE = "http://poem.ehorizon.top/roamcat/config/SolarDatumDate.json"
