...
public class SSLSocketFactoryCompat extends SSLSocketFactory {
    ...
    static String[] sProtocols = null;
    static String[] sCipherSuites = null;
    ...
    static {
        try {
            ...
            if (socket != null) {
                ...
                SSLSocketFactoryCompat.sProtocols = protocols.toArray(new String[protocols.size()]);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    SSLSocketFactoryCompat.sCipherSuites = enabledCiphers.toArray(new String[enabledCiphers.size()]);
                }
            }
        } catch (IOException e) {
    ...
    private void upgradeTLS(SSLSocket ssl) {
        ...
        // https://developer.android.com/about/versions/android-5.0-changes.html#ssl
        if (sProtocols != null) {
            ssl.setEnabledProtocols(sProtocols);
        }
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP && sCipherSuites != null) {
            ssl.setEnabledCipherSuites(sCipherSuites);
        }
    }
